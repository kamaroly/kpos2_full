...
<?php echo form_open($this->uri->uri_string(), array('id' => 'clientcontact'), array('id'=>$id));?>

	<input type="hidden" id="customer_id" name="customer_id" value="<?php echo ($this->validation->client_id) ? ($this->validation->client_id) : ($clientContactData->client_id);?>" />
	...
	<p><?php echo form_submit('createClient', $this->lang->line('clients_edit_client'), 'id="createClient" class="btn btn-small btn-info"');?></p>
