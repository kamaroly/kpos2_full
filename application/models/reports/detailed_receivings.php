...
class Detailed_receivings extends Report
{
	...
	{
		return array('summary' => array($this->lang->line('reports_receiving_id'),
				                        $this->lang->line('reports_date'), 
				                        $this->lang->line('reports_items_received'), 
				                        $this->lang->line('reports_received_by'), 
				                        $this->lang->line('reports_supplied_by'),
	...
	public function getData(array $inputs)
	{
		...
		foreach($data['summary'] as $key=>$value)
		{
			...
			$this->db->join('items_categories', 'items_categories.id = items.category_id','LEFT');
