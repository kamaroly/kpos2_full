...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('config_tin').':', 'company',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'tin',
		'id'=>'tin',
...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('config_phone_sms').':', 'phone',array('class'=>'wide required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'phone_sms',
		'id'=>'phone_sms',
		'value'=>$this->config->item('phone_sms')));?>
	</div>
</div>
	...
	<?php echo form_dropdown('timezone', 
	 array(
		...
		'Africa/Cairo'=>'(GMT+02:00) Cairo',
	 	'Africa/Cairo'=>'(GMT+2:00) Rwanda , Kigali',
		...
		), $this->config->item('timezone') ? $this->config->item('timezone') : '(GMT+2:00) Rwanda , Kigali',
			'id="select2"');
