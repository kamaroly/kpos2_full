...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('employees_mode_operation').':'); ?>
	<div class='form_field'>
<?php echo form_dropdown('working_mode', array(
		'training' => $this->lang->line('employees_mode_training'),
		'selling'  => $this->lang->line('employees_mode_sales')
		), $person_info->working_mode);
		?>
	</div>
</div>
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('config_language').':'); ?>
	<div class='form_field'>
