...
<div >
	<div id="title_bar"><?php echo $this->lang->line('common_list_of').' '.$this->lang->line('module_'.$controller_name); ?></div>
...
<div id="search_filter_section" style="display:block; <?php echo isset($search_section_state)?  ( ($search_section_state)? 'block' : 'none') : 'none';?>;background-color:#EEEEEE;">
...
<div id="table_action_header">
	<ul>
		...
		<li class="float_left"><?php echo anchor("$controller_name/bulk_edit/width:$form_width",$this->lang->line("items_bulk_edit"),array('id'=>'bulk_edit','class'=>'btn btn-small btn-primary small','title'=>$this->lang->line('items_edit_multiple_items'))); ?></span></li>
		<li class="float_left"><?php echo anchor("$controller_name/generate_barcodes",$this->lang->line("items_generate_barcodes"),array('id'=>'generate_barcodes','class'=>'btn btn-small btn-primary small', 'target' =>'_blank','title'=>$this->lang->line('items_generate_barcodes'))); ?></span></li>
	   <li class="float_left">
	   <?php echo anchor("items_categories",
		"<div class='btn btn-small btn-primary' style='float: left;'>".$this->lang->line('item_categories')."</div>",
		array('class'=>'','title'=>$this->lang->line($controller_name.'_new')));
		?>
	    </li>
	    <li class="float_left">
		<?php echo anchor("$controller_name/view//width:$form_width",
		"<div class='btn btn-small btn-success' style='float: left;'>".$this->lang->line($controller_name.'_new')."</div>",
