...
<?php endif;?>
<!-- If it's a client of a supplier request for the TIN  -->
<?php if($this->uri->segment(1)=='customers' ||$this->uri->segment(1)=='suppliers'):?>
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('common_tin').':', 'tin',array('class'=>'required')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'tin',
		'id'=>'tin',
		'value'=>$person_info->tin)
	);?>
	</div>
</div>
