...
echo img($image_properties);?>	</div>
	...
	{
	?><tr>
	<td VALIGN="TOP"colspan="3" style='text-align:right;'><?php echo $this->lang->line('sales_payment'); ?></td>
	...
	<?php foreach($payments as $payment): ?>
	   ...
	   <?php echo $payment['payment_type'] .' '.$payment['payment_amount']?>
	 </div>
	 <BR/>
	 <?php endforeach;?>
		...
		<td colspan="2" style='text-align:right'><?php echo to_currency($payments_total); ?></td>
		</tr>
