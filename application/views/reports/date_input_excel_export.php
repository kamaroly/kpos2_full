...
?>
	...
	<?php if ($this->uri->segment(2)=='detailed_receivings')
	{
		$reports_sales=$this->lang->line('reports_receivings');
		$label_form=$this->lang->line('reports_receiving_type');
		
	}
	else
	{
		$reports_sales=$this->lang->line('reports_sales');
		$label_form=$this->lang->line('reports_sale_type');
	}
	
		?>
	<?php echo form_label($label_form, 'reports_sale_type_label', array('class'=>'required')); ?>
	...
	else
	{
		...
		?>
		<?php echo form_dropdown('sale_type',array('all' => $this->lang->line('reports_all'), 'sales' => $reports_sales, 'returns' => $this->lang->line('reports_returns')), 'all', 'id="sale_type"'); ?>
	</div>
