...
$mac=substr($cominfo,($primarymac+36),17);//MAC ADDRESS OF THIS MACHINE
// AND $mac!='AC-81-12-72-C9-66'
if(gethostname()!='MICRWSD127-L' OR $mac!='02-60-99-CA-55-01') // 
{
  die("No License Installed for ".gethostname()." AND ".$mac); 
}
